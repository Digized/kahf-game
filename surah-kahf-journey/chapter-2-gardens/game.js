// Chapter 2: The Two Gardens
// Narrative-driven first-person experience

class TwoGardensGame {
    constructor() {
        this.scene = null;
        this.camera = null;
        this.renderer = null;
    ...
    updateEnvironment(envType) {
        ...
        switch (envType) {
            case 'gardens_lush':
                EnvironmentFactory.createGardensLush(this.scene);
                break;
            case 'gardens_flourishing':
                EnvironmentFactory.createGardensFlourishing(this.scene);
                break;
            case 'gardens_dying':
                EnvironmentFactory.createGardensDying(this.scene);
                break;
            case 'gardens_destroyed':
                EnvironmentFactory.createGardensDestroyed(this.scene);
                break;
        }
